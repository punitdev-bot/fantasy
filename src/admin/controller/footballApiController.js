...
class FootballApiController {
    ...
    async listOfMatches_entity(req, res) {
        try {
            ...
            let fantasy_type = "Football"
            let url = `https://soccer.entitysport.com/matches?token=44689d60663efa7ad59e4903675b794e&status=0&per_page=10&paged=1`;
...
module.exports = new FootballApiController();
